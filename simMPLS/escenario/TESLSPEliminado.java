...
/**
 * Esta clase implementa un evento que se usará para notificar que un LSP se ha
 * eliminado.
 * @author <B>Manuel Domínguez Dorado</B><br><A
 * href="mailto:ingeniero@ManoloDominguez.com">ingeniero@ManoloDominguez.com</A><br><A href="http://www.ManoloDominguez.com" target="_blank">http://www.ManoloDominguez.com</A>
 * @version 1.0
 */
public class TESLSPEliminado extends TEventoSimulacion {
     ...
     */
    public TESLSPEliminado(Object emisor, long id, long inst) {
