...
/** Clase principal del simulador. Desde aquí se crea un nuevo simulador que
...
public class openSimMPLS {
    ...
    public static void mostrarGPL() {
		try {
        	...
        	System.out.println(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("Manuel_Domínguez_Dorado"));
    ...
    /** Función principal de la aplicación. Comprueba los argumentos pasados por línea
     * de comandos e inicia el simulador si es necesario. Si no lo es, muestra la
     * licencia bajo la cual está liberado el programa.
    ...
    /** Este atributo es un objeto que almacena todas las imágenes que se van a
     * necesitar en el programa; de esta forma, aunque ocupan memoria no se cargan más
     * que una vez, mejorando la velocidad global de Open SimMPLS.
     * @since 1.0
     */    
    private static TDispensadorDeImagenes dispensadorDeImagenes;
    /** Imagen con el logo y la información del programa. Se presentará al inicio de la
     * aplicación y mientras ésta esté haciendo cosas de fondo.
     * @since 1.0
     */
    private static simMPLS.interfaz.splash.JSplash splash;
    /** Instancia del simulador que verá el usuario en la pantalla y desde donde podrá
     * hacer todo.
     * @since 1.0
     */
