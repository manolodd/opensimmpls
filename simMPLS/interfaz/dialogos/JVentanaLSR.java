...
public class JVentanaLSR extends javax.swing.JDialog {
     ...
     * @since 1.0
     */
    public JVentanaLSR(TTopologia t, JPanelDisenio pad, TDispensadorDeImagenes di, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ventanaPadre = parent;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.titulo"));
        setModal(true);
        setResizable(false);
        ...
        iconoReceptor.setIcon(dispensadorDeImagenes.obtenerIcono(TDispensadorDeImagenes.LSR));
        iconoReceptor.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.descripcion"));
        ...
        etiquetaNombre.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.etiquetaNombre"));
        ...
        iconoEnlace1.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.ConfiguracionSencilla"));
        ...
        selectorDeGenerarEstadisticasSencillo.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.GenerarEstadisticas"));
        ...
        jLabel1.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.Caracteristicas"));
        ...
        iconoEnlace2.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.ConfiguracionAvanzada"));
        ...
        selectorDeGenerarEstadisticasAvanzado.setText(java.util.ResourceBundle.getBundle("simMPLS/lenguajes/lenguajes").getString("VentanaLSR.GenerarEstadisticas"));
...
private void ratonEntraEnPanelCoordenadas(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ratonEntraEnPanelCoordenadas
     ...
     */    
    public void ponerConfiguracion(TNodoLSR tnlsr, boolean recfg) {
        configLSR = tnlsr;
