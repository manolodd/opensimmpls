...
public class JVentanaLERA extends javax.swing.JDialog {
    ...
    /**
     * Este método crea una nueva instancia de JVentanaconfigLERA
     ...
     * @since 1.0
     */
    public JVentanaLERA(TTopologia t, JPanelDisenio pad, TDispensadorDeImagenes di, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ventanaPadre = parent;
...
/** Closes the dialog */
     ...
     */
    public void ponerConfiguracion(TNodoLERA tnlera, boolean recfg) {
        configLERA = tnlera;
