...
// ............: eventos del ratón a los eventos surgidos en la simulación
// ............: y que se utilizará como base para observar el transcurso de
// ............: la simulación.
// Fecha.......: 19/02/2004
...
/**
 * Esta clase implementa un panel que recibirá eventos de simulación y los
 * representará en pantalla dando la sensación de continuidad a una simulación
 * visual.
...
public class JPanelSimulacion extends javax.swing.JPanel {
     ...
     * Crea una nueva instancia de JPanelSimulacion
     * @since 1.0
     * @param di Dispensador de imágenes de donde el panel tomará las imágenes que necesite
     * mostrar en pantalla.
     */    
    ...
    /**
     * Reincia todos los atributos de la clase a su valor de creación.
     * @since 1.0
     */    
    public void reset() {
        cerrojo.bloquear();
    ...
    /**
     * Este método envía un evento al fichero de traza, para que quede registrado.
     * @param es Evento de simulación que se desea tracear.
     * @since 1.0
     */    
    ...
    /**
     * Este método establece el fichero de traza.
    ...
    /**
     * Este método asocia al panel de simulación una topologia concreta.
     * @since 1.0
     * @param t Topología que se debe representar en el panel de simulación.
     */    
    ...
    /**
     * Este método asigna un dispensador de imágenes al panel de forma que de ahí
     * tomará todas las imágenes que deba mostrar en la pantalla.
     * @since 1.0
    ...
    /**
     * Este método determina que grosor en píxeles debe tener un enlace de la topología
     * al ser mostrado, segun su delay.
     * @since 1.0
     * @param delay Retardo del enlace.
     * @return Grosor en píxeles que se debe usar para mostrar el enlace.
     */    
...
//
    ...
    /**
     * Este método permite establecer cuantos milisegundos de espera va a haber entre
     * que se muestra un tic en la simulación, y se meustra el siguiente. A efectos
     * prácticos permite ralentizar la simulación en tiempo real.
     * @param mls Número de milisegundos de retardo entre frames de una misma simulación.
     * @since 1.0
     */    
    ...
    /**
     * Este método permite añadir un evento a la lista de eventos que se deben mostrar
     * en la ventana del simulador.
     * @param evt El nuevo evento que se debe mostrar en la simulación.
     * @since 1.0
     */    
    ...
    /**
     * Este método permite dibujar los eventos relacionados con las PDU's que circulan
     * por la red.
     * @since 1.0
     * @param g2D El lienzo donde se mostrará el evento.
     */    
    ...
    /**
     * Este método permite representar los eventos que tengan que ver con los nodos.
     * @since 1.0
     * @param g2D El lienzo donde se mostrará el evento.
     */    
    ...
    /**
     * Este método permite tratar los eventos que tienen que ver con los enlaces de
     * comunicaciones.
     * @since 1.0
     * @param g2D El lienzo donde se mostrará el evento.
     */    
    ...
    /**
     * Este método muestra un contador en la ventana de simulación que indica el
     * nanosegundo de simulación que por el que se va.
     * @since 1.0
     * @param g2D El lienzo donde se mostrará el contador.
     */    
    ...
    /**
     * Este método dibuja en el panel de simulación una leyenda con los objetos que
     * aparecerán en la simulación. Siempre, por supuesto, que la leyenda esté
     * configurada para aparecer.
     * @param g2D Lienzo del panel de simulación, donde se dibujará la leyenda.
     * @since 1.0
     */    
    ...
    /**
     * Este método permite obtener una representación de la simulación en un momento,
     * en forma de imagen bitmap.
     * @since 1.0
     * @return Una imagen accesible, cuyo contenido es una captura de la simulación.
     */    
    ...
    /**
     * Este método redibuja el panel de simulación cada vez que es necesario.
     * @since 1.0
     * @param g El lienzo donde se debe redibujar el panel de simulación.
     */    
    ...
    /**
     * Este método permite averiguar si el simulador está mostrando la leyenda o no.
     * @return TRUE, si se está mostrando la leyenda. FALSE en caso contrario.
     * @since 1.0
     */    
    ...
    /**
     * Este método permite establecer si el simulador mostrará la leyenda o no.
