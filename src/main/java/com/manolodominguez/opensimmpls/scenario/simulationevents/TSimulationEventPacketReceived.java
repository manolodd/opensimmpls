...
public class TSimulationEventPacketReceived extends TSimulationEvent {
     ...
     * TSimulationEventPacketReceived.
     *
     * @author Manuel Domínguez Dorado - ingeniero@ManoloDominguez.com
     ...
     * generated.
     * @param packetSize The size of the packet received.
     * @since 2.0
     */
    public TSimulationEventPacketReceived(Object source, long eventID, long timeInstant, int packetType, int packetSize) {
    ...
    /**
     * This method gets the type of the packet received by the source node.
     *
     * @author Manuel Domínguez Dorado - ingeniero@ManoloDominguez.com
     * @return the type of the packet received by the source node. One of the
     ...
     * TSimulationEvent.PACKET_RECEIVED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.PACKET_RECEIVED;
    }
