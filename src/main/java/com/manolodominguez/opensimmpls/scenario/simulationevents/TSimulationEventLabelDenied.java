...
public class TSimulationEventLabelDenied extends TSimulationEvent {
     ...
     * @since 2.0
     */
    public TSimulationEventLabelDenied(Object source, long eventID, long timeInstant) {
     ...
     * TSimulationEvent.LABEL_DENIED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.LABEL_DENIED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha denegado una etiqueta";
        return (string);
    }
}
