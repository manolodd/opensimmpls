 ...
 * @version 2.0
 */
public class TOuterLink extends TLink implements ITimerEventListener, Runnable {
     ...
     * @since 2.0
     */
    public TOuterLink(int linkID, TLongIDGenerator longIDGenerator, TTopology topology) {
