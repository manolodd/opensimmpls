...
public class TIPv4AddressGenerator {
     ...
     * @throws EIPv4GeneratorOverflow Cuando el generador sobrepasa el rango de direcciones IP para el que est�
 ...
 m�todo, indicando que el generador no puede cumplir sus funci�n.
     ...
     * @since 2.0
     */
    public String obtenerIP() throws EIPv4GeneratorOverflow {
        if (octeto4 < 255) {
            octeto4++;
        } else {
            if (octeto3 < 255) {
                ...
                if (octeto2 < 254) {
                    ...
                    throw new EIPv4GeneratorOverflow();
                }
            }
        }
