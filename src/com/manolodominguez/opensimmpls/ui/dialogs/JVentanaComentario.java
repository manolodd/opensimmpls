...
public class JVentanaComentario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton2.setMnemonic(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.mnemonico.enviar").charAt(0));
        ...
        jButton3.setMnemonic(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.mnemonico.cancelar").charAt(0));
    ...
    if (estado == CORRECTO) {
        ...
        if (estadoConexion != TSMTP.CONNECTION_ERROR) {
            ...
            if (estadoEnvio != 0) {
                ...
                va.mostrarMensaje(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaComentario.ErrorEnviando"));
                va.show();
            } else {
                this.setVisible(false);
                this.dispose();
            ...
            JVentanaAdvertencia va = new JVentanaAdvertencia(ventanaPadre, true, dispensadorDeImagenes);
            va.mostrarMensaje(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.ErrorAlConectar"));
            va.show();
        }
    } else {
        JVentanaAdvertencia va = new JVentanaAdvertencia(ventanaPadre, true, dispensadorDeImagenes);
        switch (estado) {
            case SERVIDOR_VACIO:{
                va.mostrarMensaje(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.debePonerSMTP"));
                break;
            }
            case REMITE_VACIO:{
                va.mostrarMensaje(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.DebePonerSuEmail"));
                break;
            }
            case SIN_COMENTARIO: {
                va.mostrarMensaje(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaComentario.DebePonerComentario"));
                break;
            }
        }
        va.show();
