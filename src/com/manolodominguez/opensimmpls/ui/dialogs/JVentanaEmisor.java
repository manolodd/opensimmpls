...
public class JVentanaEmisor extends javax.swing.JDialog {
    ...
    public void initComponents2() {
        ...
        emisor = null;
        coordenadaX.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.X=_") + panelCoordenadas.obtenerXReal());
        coordenadaY.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Y=_") + panelCoordenadas.obtenerYReal());
        ...
        this.selectorDeGoS.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.None"));
        this.selectorDeGoS.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Level_1"));
        this.selectorDeGoS.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Level_2"));
        this.selectorDeGoS.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Level_3"));
        this.selectorDeGoS.setSelectedIndex(0);
        this.selectorSencilloTrafico.removeAllItems();
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Personalized"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Email"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Web"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.P2P_file_sharing"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Bank_data_transaction"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Tele-medical_video"));
        this.selectorSencilloTrafico.addItem(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Bulk_traffic"));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TituloVentana"));
        setModal(true);
        setResizable(false);
        ...
        iconoEmisor.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.DescripcionNodo"));
        ...
        etiquetaNombre.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Etiqueta.NombreNodo"));
        panelGeneral.add(etiquetaNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 105, 120, -1));

        nombreNodo.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.Nombre"));
        ...
        panelPosicion.setBorder(new javax.swing.border.TitledBorder(null, java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Etiqueta.Posicion"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12)));
        coordenadaX.setFont(new java.awt.Font("Dialog", 0, 12));
        coordenadaX.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.X=_45"));
        ...
        coordenadaY.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Y=_1024"));
        ...
        panelCoordenadas.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.posicion"));
        ...
        verNombre.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Etiqueta.VerNombre"));
        verNombre.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.VerNombre"));
        panelGeneral.add(verNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 175, -1, -1));

        jLabel6.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.DestinoTrafico"));
        ...
        selectorDelReceptor.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.destinodeltrafico"));
        panelGeneral.add(selectorDelReceptor, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, -1, -1));

        panelPestanias.addTab(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Tab.General"), panelGeneral);
        ...
        iconoEnlace1.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.configuracionRapida"));
        panelRapido.add(iconoEnlace1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 20, 335, -1));

        jLabel1.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TipoDeTrafico1"));
        ...
        selectorDeGenerarEstadisticasSencillo.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.GenerarEstadisticas1"));
        selectorDeGenerarEstadisticasSencillo.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.GenerarEstadisticas1"));
        ...
        selectorSencilloTrafico.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TipoDeTrafico1"));
        ...
        panelPestanias.addTab(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Tab.Rapida"), panelRapido);
        ...
        iconoEnlace2.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.ConfiguracionAvanzada"));
        panelAvanzado.add(iconoEnlace2, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 20, 335, -1));

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TasaDeTrafico"));
        ...
        etiquetaTasa.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Kbpsinicial"));
        ...
        selectorDeGenerarEstadisticas.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.GenerarEstadisticas2"));
        selectorDeGenerarEstadisticas.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.GenerarEstadisticas2"));
        ...
        jLabel4.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.NivelDeGoS"));
        ...
        selectorDeGoS.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.nivelDeGoS"));
        ...
        selectorLSPDeRespaldo.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.CrearLSPBackup"));
        selectorLSPDeRespaldo.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.crearUnLSPdeBackup"));
        ...
        jLabel5.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TipoDeTrafico3"));
        ...
        traficoConstante.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TraficoConstante"));
        traficoConstante.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.traficoConstante"));
        ...
        traficoVariable.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.TraficoVariable"));
        traficoVariable.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.traficovariable"));
        ...
        encapsularSobreMPLS.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.EncapsularSobreMPLS"));
        encapsularSobreMPLS.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.encapsularsobrempls"));
        ...
        selectorDeTasa.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltipo.CambiarTasa"));
        ...
        selectorDeTamPaquete.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltipo.CambiarTasa"));
        ...
        etiquetaTamPaquete.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.TamCargaUtil"));
        ...
        panelPestanias.addTab(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Tab.Avanzada"), panelAvanzado);
        ...
        jButton2.setMnemonic(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.botones.Aceptar").charAt(0));
        jButton2.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Boton.Aceptar.Texto"));
        jButton2.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.Aceptar"));
        ...
        jButton3.setMnemonic(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.botones.Cancelar").charAt(0));
        jButton3.setText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.Boton.Cancelar.Texto"));
        jButton3.setToolTipText(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.tooltip.Cancelar"));
    ...
    String unidades = java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("JVentanaEmisor.Octetos");
...
private void cambioEnSelectorDeTasa(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_cambioEnSelectorDeTasa
    ...
    String unidades = java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("VentanaEmisor.unidades.kbps");
