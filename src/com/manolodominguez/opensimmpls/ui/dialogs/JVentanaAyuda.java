...
public class JVentanaAyuda extends javax.swing.JDialog {
     ...
     */
    public JVentanaAyuda(java.awt.Frame parent, boolean modal, TImagesBroker di) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jButton1.setMnemonic(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/resources/translations/translations").getString("VentanaAyuda.OK.Mnemonico").charAt(0));
