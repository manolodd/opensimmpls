...
public class TSimulationEventLabelRequested extends TSimulationEvent {
     ...
     * TSimulationEventLabelRequested.
     *
     * @author Manuel Domínguez Dorado - ingeniero@ManoloDominguez.com
     ...
     * @since 2.0
     */
    public TSimulationEventLabelRequested(Object source, long eventID, long timeInstant) {
     ...
     * TSimulationEvent.LABEL_REQUESTED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.LABEL_REQUESTED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha solicitado una etiqueta";
        return (string);
    }
}
