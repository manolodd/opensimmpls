...
public class TSimulationEventPacketDiscarded extends TSimulationEvent {
     ...
     * @param packetType The congestion level advertised by the source node. A
     * value between 0 and 100 (without decimals).
     * @since 2.0
     */
    public TSimulationEventPacketDiscarded(Object source, long eventID, long timeInstant, int packetType) {
        super(source, eventID, timeInstant);
        this.packetType = packetType;
    }

    /**
     * This method gets the type of the packet discarded by the source node.
     *
     * @author Manuel Domínguez Dorado - ingeniero@ManoloDominguez.com
     * @return the type of the packet discarded by the source node. One of the
     ...
     * TSimulationEvent.PACKET_DISCARDED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.PACKET_DISCARDED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha descartado un paquete ";
