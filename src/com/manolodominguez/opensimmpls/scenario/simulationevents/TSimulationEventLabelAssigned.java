...
/**
 * This class implements a simulation event that is generated when a new MPLS
 * label is assigned.
 *
...
public class TSimulationEventLabelAssigned extends TSimulationEvent {
     ...
     * @since 2.0
     */
    public TSimulationEventLabelAssigned(Object source, long eventID, long timeInstant) {
     ...
     * TSimulationEvent.LABEL_ASSIGNED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.LABEL_ASSIGNED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha concedido una etiqueta";
        return (string);
    }
}
