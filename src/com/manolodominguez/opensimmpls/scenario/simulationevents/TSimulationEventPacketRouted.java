...
public class TSimulationEventPacketRouted extends TSimulationEvent {
     ...
     * @since 2.0
     */
    public TSimulationEventPacketRouted(Object source, long eventID, long timeInstant, int packetType) {
        super(source, eventID, timeInstant);
        this.packetType = packetType;
    }

    /**
     * This method gets the type of the packet routed by the source node.
     *
     * @author Manuel Domínguez Dorado - ingeniero@ManoloDominguez.com
     * @return the type of the packet routed by the source node. One of the
     ...
     * TSimulationEvent.PACKET_ROUTED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.PACKET_ROUTED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha encaminado un paquete ";
