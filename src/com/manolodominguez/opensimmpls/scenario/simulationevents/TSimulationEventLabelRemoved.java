...
public class TSimulationEventLabelRemoved extends TSimulationEvent {
     ...
     * @since 2.0
     */
    public TSimulationEventLabelRemoved(Object source, long eventID, long timeInstant) {
     ...
     * TSimulationEvent.LABEL_REMOVED.
     * @since 2.0
     */
    @Override
    public int getSubtype() {
        return TSimulationEvent.LABEL_REMOVED;
    }
    ...
    public String toString() {
        ...
        string += "] ";
        // FIX: i18N needed
        string += "ha eliminado una etiqueta";
        return (string);
    }
}
