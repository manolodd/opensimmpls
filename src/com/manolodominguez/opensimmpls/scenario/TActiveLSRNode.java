    ...
    public String getErrorMessage(int errorCode) {
        switch (errorCode) {
            case TActiveLSRNode.UNNAMED:
                return (java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TConfigLSR.FALTA_NOMBRE"));
            case TActiveLSRNode.NAME_ALREADY_EXISTS:
                return (java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TConfigLSR.NOMBRE_REPETIDO"));
            case TActiveLSRNode.ONLY_BLANK_SPACES:
                return (java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TNodoLSR.NombreNoSoloEspacios"));
        }
        return ("");
    }
