...
public class TTopology {
    ...
    public void addNode(TNode nodo) {
        ...
        try {
            nodo.addListenerSimulacion(escenarioPadre.getSimulation().getSimulationEventCollector());
 ...
 los valores pasados.
    ...
    public void addLink(TLink enlace) {
        ...
        try {
            enlace.addListenerSimulacion(escenarioPadre.getSimulation().getSimulationEventCollector());
        } catch (ESimulationSingleSubscriber e) {System.out.println(e.toString());}
    }
