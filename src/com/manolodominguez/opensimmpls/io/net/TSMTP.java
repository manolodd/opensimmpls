 ...
 */
package com.manolodominguez.opensimmpls.io.net;
                    ...
                    if (remoteSMTPHostResponse.startsWith("250")) {
                        ...
                        if ((remoteSMTPHostResponse.startsWith("250")) || (remoteSMTPHostResponse.startsWith("251"))) {
                            ...
                            if (remoteSMTPHostResponse.startsWith("354")) {
                                printStream.println(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TSMTP.Subject"));
                                printStream.println(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TSMTP.XSoftware"));
                                printStream.println(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TSMTP.Programador"));
                                printStream.println(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TSMTP.ProgramadorWeb"));
                                printStream.println(java.util.ResourceBundle.getBundle("com/manolodominguez/opensimmpls/lenguajes/lenguajes").getString("TSMTP.ProgramadorEmail"));
