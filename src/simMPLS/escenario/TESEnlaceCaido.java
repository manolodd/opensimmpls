...
/**
 * Esta clase implementa un evento de simulación para notificar la caída de un
 * enlace.
 * @author <B>Manuel Domínguez Dorado</B><br><A
 * href="mailto:ingeniero@ManoloDominguez.com">ingeniero@ManoloDominguez.com</A><br><A href="http://www.ManoloDominguez.com" target="_blank">http://www.ManoloDominguez.com</A>
 * @version 1.0
 */
public class TESEnlaceCaido extends TEventoSimulacion {
     ...
     */
    public TESEnlaceCaido(Object emisor, long id, long inst) {
