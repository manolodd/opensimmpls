 ...
 * @version 1.0
 */
public class TESPaqueteEnviado extends TEventoSimulacion {
     ...
     */
    public TESPaqueteEnviado(Object emisor, long id, long inst, int tipoPaquete) {
        super(emisor, id, inst);
        tipoP = tipoPaquete;
    }

    /**
     * ste método obtiene el tipo del paquete al que se refiere el evento.
    ...
    /**
     * Este método obtiene una representaci´no textual del tipo del paquete al que se
     * refiere el evento.
