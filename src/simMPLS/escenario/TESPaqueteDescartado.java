...
/**
 * Esta clase implementa un evento que será usado para notificar que un paquete has
 * sido descartado.
 * @author <B>Manuel Domínguez Dorado</B><br><A
 * href="mailto:ingeniero@ManoloDominguez.com">ingeniero@ManoloDominguez.com</A><br><A href="http://www.ManoloDominguez.com" target="_blank">http://www.ManoloDominguez.com</A>
 * @version 1.0
 */
public class TESPaqueteDescartado extends TEventoSimulacion {

    /**
     * Crea una nueva instancia de TESPqueteDescartado.
     * @since 1.0
     * @param inst Instante de tiempo en el que se generó el evento.
     * @param emisor Nodo que generó ele evento.
     * @param id Identificador único del evento.
     * @param tipoPaquete Tipo del paquete que se ha descartado (de qué trafico es).
     */
    public TESPaqueteDescartado(Object emisor, long id, long inst, int tipoPaquete) {
        super(emisor, id, inst);
        tipoP = tipoPaquete;
    }

    /**
     * Este método devuelve el tipo del paquete que descartó el nodo que generó el
     * evento.
     * @return Tipo del paquete que se descartó.
     * @since 1.0
     */    
    ...
    /**
     * Este método ofrece una representación textual del tipo el paquete descartado.
     * @return Representación textual del paquete descartado.
     * @since 1.0
     */    
