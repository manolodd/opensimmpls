...
/**
 * Esta clase implementa un evento que será usado para notificar que se ha
 * solicitado una etiqueta MPLS
 * @author <B>Manuel Domínguez Dorado</B><br><A
 * href="mailto:ingeniero@ManoloDominguez.com">ingeniero@ManoloDominguez.com</A><br><A href="http://www.ManoloDominguez.com" target="_blank">http://www.ManoloDominguez.com</A>
 * @version 1.0
 */
public class TESEtiquetaSolicitada extends TEventoSimulacion {
     ...
     */
    public TESEtiquetaSolicitada(Object emisor, long id, long inst) {
    ...
    public int obtenerSubtipo() {
        return super.ETIQUETA_SOLICITADA;
    }
