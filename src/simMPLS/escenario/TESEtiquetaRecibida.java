...
/**
 * Esta clase implementa un evento que será usado para notificar que una etiqueta
 * se ha recibido.
 * @author <B>Manuel Domínguez Dorado</B><br><A
 * href="mailto:ingeniero@ManoloDominguez.com">ingeniero@ManoloDominguez.com</A><br><A href="http://www.ManoloDominguez.com" target="_blank">http://www.ManoloDominguez.com</A>
 * @version 1.0
 */
public class TESEtiquetaRecibida extends TEventoSimulacion {
     ...
     */
    public TESEtiquetaRecibida(Object emisor, long id, long inst) {
