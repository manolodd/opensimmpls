...
/**
 * Esta clase implementa las estadísticas de un nodo LSRA.
...
public class TEstadisticasLSRA extends TEstadisticas {
    ...
    /**
     * Este método amplia las estadísticas añadiendo las correspondientes al paquete
     * especificado.
    ...
    /**
     * Este método permite obtener el número de graficas del LSRA.
     * @return El número de gráficas del LSRA.
     * @since 1.0
     */    
    ...
    /**
     * Este método actualiza las estadísticas con los ultimos datos recogidos desde la
     * última llamada a este método.
     * @param instante Instante de tiempo al que se atribuirán los ultimso datos.
     * @since 1.0
     */    
