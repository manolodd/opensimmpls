...
public class TEntradaPuertoActivo implements Comparable {
    ...
    /**
     * Este m�todo sirve para comparar dos instancias de TEntradaPuertoActivo.
    ...
    public int compareTo(Object o) {
        ...
        if (this.ordenDeLlegada < parametro.obtenerOrdenDeLlegada()) {
            return TEntradaPuertoActivo.PRIMERO_EL_ACTUAL;
        }
        if (this.ordenDeLlegada > parametro.obtenerOrdenDeLlegada()) {
            return TEntradaPuertoActivo.PRIMERO_EL_PARAMETRO;
        }
        return TEntradaPuertoActivo.IGUALES;
    }
