...
public abstract class TNodePorts {
     ...
     * @since 1.0
     */    
    public void ponerNodo(TTopologyNode n) {
        nodo = n;
    }
     ...
     * @since 1.0
     */    
    public TTopologyNode obtenerNodo() {
        return nodo;
    }
     ...
     * @since 1.0
     */    
    public abstract TPort obtenerPuertoDestino(String ip);
    /**
     ...
     * @since 1.0
     */    
    public abstract void ponerEnlaceEnPuerto(TTopologyLink e, int p);
    /**
     ...
     * @since 1.0
     */    
    public abstract TTopologyLink obtenerEnlaceDePuerto(int p);
    /**
     ...
     * @since 1.0
     */    
    public abstract TPort obtenerPuerto(int numPuerto);
    /**
