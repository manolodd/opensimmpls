...
// Descripci�n.: Implementaci�n de una ventana hija que se crear� cada vez
// ............: que se cree un escenario de simulaci�n nuevo. En ella se
// ............: desarrolla toda la actividad en el proceso de creaci�n, si-
// ............: mulaci�n y an�lisis de resultados de un escenario concreto.
// Fecha.......: 19/02/2004
...
public class JVentanaHija extends javax.swing.JInternalFrame {
     ...
     * @since 1.0
     */    
    public JVentanaHija(JSimulador padre, TDispensadorDeImagenes di, TScenario esc) {
        dispensadorDeImagenes = di;
        VentanaPadre = padre;
        initComponents();
        initComponents2();
    ...
    /** Este m�todo se encarga de iniciar los atributos de la clase que no hayan sido
