package simMPLS.interfaz.splash;
...
public class JSplash extends javax.swing.JFrame {
    ...
    /** Este método es el constructor de la clase; crea una nueva instancia de JSplash.
     * @since 1.0
     */
    public JSplash() {
        initComponents();
    ...
    /** Este método se llama desde el constructor para dar los valores por defecto a los
    ...
    /** Este método muestra en la ventana de inicio el texto que se especifique.
     * @param txt Texto que se mostrará en el recuadro blanco de la ventana.
     * @since 1.0
     */
